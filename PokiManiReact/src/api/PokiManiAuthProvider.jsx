...
export const PokiManiAuthProvider = ({ children }) => {
  ...
  const login = async (username, password) => {
    try {
      const response = await pokiManiApiAxios.post('/Auth/token', { userName: username, password: password });
  ...
  return (
    <PokiManiAuthContext.Provider value={{ isAuthenticated, setIsAuthenticated, login, logout, refresh }}>
      {children}
